                    ...
                    <View style={styles.container}>
                        ...
                        <TouchableOpacity style={styles.product_card} onPress={() => {
                            ...
                            <View style={styles.right}>
                                <Text style={{ color: '#4BB543', fontSize: 10 }}>Order Received</Text>
                        ...
                        <TouchableOpacity style={styles.product_card} onPress={() => {
                            ...
                            <View style={styles.right}>
                                <Text style={{ color: '#c1272d', fontSize: 10 }}>Order Cancelled</Text>
                                <Text>Rs. <Text style={{ color: '#4BB453', fontWeight: 'bold' }}>1000/-</Text></Text>
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity style={styles.product_card} onPress={() => {
                            ...
                            <View style={styles.right}>
                                <Text style={{ color: '#ffcc00', fontSize: 10 }}>Pick up order</Text>
                                <Text>Rs. <Text style={{ color: '#4BB453', fontWeight: 'bold' }}>1000/-</Text></Text>
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity style={styles.product_card} onPress={() => {
                            ...
                            <View style={styles.right}>
                                <Text style={{ color: '#4BB543', fontSize: 10 }}>Picked up order</Text>
                                <Text>Rs. <Text style={{ color: '#4BB453', fontWeight: 'bold' }}>1000/-</Text></Text>
                            </View>
                        </TouchableOpacity>
...
const all_order = StyleSheet.create({
